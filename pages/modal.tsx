...
const Modal: NextPage = () => {
    ...
    return (
        <>
            <div className="p-2">
            <button className="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded" onClick={handleOpen}>Create a new markdown file</button>
            </div>
            <div className="pt-2 flex space-x-2 items-center justify-center">
                <ReactModal className="h-1/5 w-1/2 items-center justify-center" isOpen={isOpen} onRequestClose={handleClose} onAfterOpen={handleFocusInput}>
                    <input
                        ref={inputRef}
